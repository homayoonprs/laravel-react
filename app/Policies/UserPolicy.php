...
class UserPolicy
{
    ...
    /**
     * Determine whether the user can Sync model Permissions.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return \Illuminate\Auth\Access\Response|bool
    ...
    {
        return $user->hasPermissionTo('user_sync_permission');
    }

    /**
     * Determine whether the user can Sync model Roles.
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\User  $model
     * @return \Illuminate\Auth\Access\Response|bool
    ...
    {
        return $user->hasPermissionTo('user_sync_role');
    }
}
